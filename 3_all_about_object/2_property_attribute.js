 ...
 * 3) enumerable - 열거가 가능한지에 대한 여부 for...in 루프를 등을 사용할 수 있으면 true를 반환
...
console.log("---------------------------------");
console.log(Object.getOwnPropertyDescriptor(yuJin, "name"));
console.log(console.log(Object.getOwnPropertyDescriptors(yuJin)));
 ...
 */
console.log("---------------------------------");
Object.defineProperty(yuJin2, "height", { configurable: false });
console.log(Object.getOwnPropertyDescriptor(yuJin2, "height"));

// Object.defineProperty(yuJin2, "height", { enumerable: false });
Object.defineProperty(yuJin2, "height", {
  value: 172,
});
console.log(Object.getOwnPropertyDescriptor(yuJin2, "height"));
...
//   writable: true,
// });
// value와 writable의 false 변경은 된다
// 하지만 writable의 false -> true 변경은 안된다
